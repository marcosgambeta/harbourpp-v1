...
extern HB_EXPORT int32_t hb_wstrcmp( const HB_WCHAR * s1, const HB_WCHAR * s2 );
extern HB_EXPORT int32_t hb_wstrncmp( const HB_WCHAR * s1, const HB_WCHAR * s2, HB_SIZE nCount );
...
extern HB_EXPORT const char * hb_parstr_utf8( int32_t iParam, void ** phString, HB_SIZE * pnLen );
extern HB_EXPORT const HB_WCHAR * hb_parstr_u16( int32_t iParam, int32_t iEndian, void ** phString, HB_SIZE * pnLen );

extern HB_EXPORT const char * hb_parastr( int32_t iParam, HB_SIZE nIndex, void * cdp, void ** phString, HB_SIZE * pnLen );
extern HB_EXPORT const char * hb_parastr_utf8( int32_t iParam, HB_SIZE nIndex, void ** phString, HB_SIZE * pnLen );
extern HB_EXPORT const HB_WCHAR * hb_parastr_u16( int32_t iParam, HB_SIZE nIndex, int32_t iEndian, void ** phString, HB_SIZE * pnLen );

extern HB_EXPORT void hb_retstr( void * cdp, const char * szText );
extern HB_EXPORT void hb_retstr_utf8( const char * szText );
extern HB_EXPORT void hb_retstr_u16( int32_t iEndian, const HB_WCHAR * szText );
...
extern HB_EXPORT void hb_retstrlen_u16( int32_t iEndian, const HB_WCHAR * szText, HB_SIZE nLen );

extern HB_EXPORT int32_t hb_storstr( void * cdp, const char * szText, int32_t iParam );
extern HB_EXPORT int32_t hb_storstr_utf8( const char * szText, int32_t iParam );
extern HB_EXPORT int32_t hb_storstr_u16( int32_t iEndian, const HB_WCHAR * szText, int32_t iParam );

extern HB_EXPORT int32_t hb_storstrlen( void * cdp, const char * szText, HB_SIZE nLen, int32_t iParam );
extern HB_EXPORT int32_t hb_storstrlen_utf8( const char * szText, HB_SIZE nLen, int32_t iParam );
extern HB_EXPORT int32_t hb_storstrlen_u16( int32_t iEndian, const HB_WCHAR * szText, HB_SIZE nLen, int32_t iParam );
