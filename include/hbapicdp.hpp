...
} HB_CODEPAGE, * PHB_CODEPAGE; // PHB_CODEPAGE is deprecated in core code

#if defined(__cplusplus)
constexpr const char *HB_CPID_437 = "cp437"; // #define HB_CPID_437        "cp437"
constexpr const char *HB_CPID_737 = "cp737"; // #define HB_CPID_737        "cp737"
constexpr const char *HB_CPID_775 = "cp775"; // #define HB_CPID_775        "cp775"
constexpr const char *HB_CPID_850 = "cp850"; // #define HB_CPID_850        "cp850"
constexpr const char *HB_CPID_852 = "cp852"; // #define HB_CPID_852        "cp852"
constexpr const char *HB_CPID_855 = "cp855"; // #define HB_CPID_855        "cp855"
constexpr const char *HB_CPID_857 = "cp857"; // #define HB_CPID_857        "cp857"
constexpr const char *HB_CPID_858 = "cp858"; // #define HB_CPID_858        "cp858"
constexpr const char *HB_CPID_860 = "cp860"; // #define HB_CPID_860        "cp860"
constexpr const char *HB_CPID_861 = "cp861"; // #define HB_CPID_861        "cp861"
constexpr const char *HB_CPID_862 = "cp862"; // #define HB_CPID_862        "cp862"
constexpr const char *HB_CPID_863 = "cp863"; // #define HB_CPID_863        "cp863"
constexpr const char *HB_CPID_864 = "cp864"; // #define HB_CPID_864        "cp864"
constexpr const char *HB_CPID_865 = "cp865"; // #define HB_CPID_865        "cp865"
constexpr const char *HB_CPID_866 = "cp866"; // #define HB_CPID_866        "cp866"
constexpr const char *HB_CPID_869 = "cp869"; // #define HB_CPID_869        "cp869"
constexpr const char *HB_CPID_874 = "cp874"; // #define HB_CPID_874        "cp874"
constexpr const char *HB_CPID_1125 = "cp1125"; // #define HB_CPID_1125       "cp1125"
constexpr const char *HB_CPID_1250 = "cp1250"; // #define HB_CPID_1250       "cp1250"
constexpr const char *HB_CPID_1251 = "cp1251"; // #define HB_CPID_1251       "cp1251"
constexpr const char *HB_CPID_1252 = "cp1252"; // #define HB_CPID_1252       "cp1252"
constexpr const char *HB_CPID_1253 = "cp1253"; // #define HB_CPID_1253       "cp1253"
constexpr const char *HB_CPID_1254 = "cp1254"; // #define HB_CPID_1254       "cp1254"
constexpr const char *HB_CPID_1255 = "cp1255"; // #define HB_CPID_1255       "cp1255"
constexpr const char *HB_CPID_1256 = "cp1256"; // #define HB_CPID_1256       "cp1256"
constexpr const char *HB_CPID_1257 = "cp1257"; // #define HB_CPID_1257       "cp1257"
constexpr const char *HB_CPID_1258 = "cp1258"; // #define HB_CPID_1258       "cp1258"
constexpr const char *HB_CPID_8859_1 = "iso8859-1"; // #define HB_CPID_8859_1     "iso8859-1"
constexpr const char *HB_CPID_8859_1B = "iso8859-1b"; // #define HB_CPID_8859_1B    "iso8859-1b"
constexpr const char *HB_CPID_8859_2 = "iso8859-2"; // #define HB_CPID_8859_2     "iso8859-2"
constexpr const char *HB_CPID_8859_3 = "iso8859-3"; // #define HB_CPID_8859_3     "iso8859-3"
constexpr const char *HB_CPID_8859_4 = "iso8859-4"; // #define HB_CPID_8859_4     "iso8859-4"
constexpr const char *HB_CPID_8859_5 = "iso8859-5"; // #define HB_CPID_8859_5     "iso8859-5"
constexpr const char *HB_CPID_8859_6 = "iso8859-6"; // #define HB_CPID_8859_6     "iso8859-6"
constexpr const char *HB_CPID_8859_7 = "iso8859-7"; // #define HB_CPID_8859_7     "iso8859-7"
constexpr const char *HB_CPID_8859_8 = "iso8859-8"; // #define HB_CPID_8859_8     "iso8859-8"
constexpr const char *HB_CPID_8859_9 = "iso8859-9"; // #define HB_CPID_8859_9     "iso8859-9"
constexpr const char *HB_CPID_8859_10 = "iso8859-10"; // #define HB_CPID_8859_10    "iso8859-10"
constexpr const char *HB_CPID_8859_11 = "iso8859-11"; // #define HB_CPID_8859_11    "iso8859-11"
constexpr const char *HB_CPID_8859_13 = "iso8859-13"; // #define HB_CPID_8859_13    "iso8859-13"
constexpr const char *HB_CPID_8859_14 = "iso8859-14"; // #define HB_CPID_8859_14    "iso8859-14"
constexpr const char *HB_CPID_8859_15 = "iso8859-15"; // #define HB_CPID_8859_15    "iso8859-15"
constexpr const char *HB_CPID_8859_16 = "iso8859-16"; // #define HB_CPID_8859_16    "iso8859-16"
constexpr const char *HB_CPID_KOI_8 = "koi-8"; // #define HB_CPID_KOI_8      "koi-8"
constexpr const char *HB_CPID_KOI_8U = "koi-8u"; // #define HB_CPID_KOI_8U     "koi-8u"
constexpr const char *HB_CPID_KAM = "kamenicky"; // #define HB_CPID_KAM        "kamenicky"
constexpr const char *HB_CPID_MAZ = "mazovia"; // #define HB_CPID_MAZ        "mazovia"
constexpr const char *HB_CPID_MIK = "bg-mik"; // #define HB_CPID_MIK        "bg-mik"
constexpr const char *HB_CPID_037 = "cp037"; // #define HB_CPID_037        "cp037"
constexpr const char *HB_CPID_424 = "cp424"; // #define HB_CPID_424        "cp424"
constexpr const char *HB_CPID_500 = "cp500"; // #define HB_CPID_500        "cp500"
constexpr const char *HB_CPID_856 = "cp856"; // #define HB_CPID_856        "cp856"
constexpr const char *HB_CPID_875 = "cp875"; // #define HB_CPID_875        "cp875"
constexpr const char *HB_CPID_1006 = "cp1006"; // #define HB_CPID_1006       "cp1006"
constexpr const char *HB_CPID_1026 = "cp1026"; // #define HB_CPID_1026       "cp1026"
constexpr const char *HB_CPID_10000 = "macroman"; // #define HB_CPID_10000      "macroman"
constexpr const char *HB_CPID_10006 = "macgreek"; // #define HB_CPID_10006      "macgreek"
constexpr const char *HB_CPID_10007 = "maccyrillic"; // #define HB_CPID_10007      "maccyrillic"
constexpr const char *HB_CPID_10029 = "maccentraleurope"; // #define HB_CPID_10029      "maccentraleurope"
constexpr const char *HB_CPID_10079 = "maciceland"; // #define HB_CPID_10079      "maciceland"
constexpr const char *HB_CPID_10081 = "macturkish"; // #define HB_CPID_10081      "macturkish"
constexpr const char *HB_CPID_ATARIST = "atarist"; // #define HB_CPID_ATARIST    "atarist"
constexpr const char *HB_CPID_NEXTSTEP = "nextstep"; // #define HB_CPID_NEXTSTEP   "nextstep"
constexpr const char *HB_CPID_USASCII = "us-ascii"; // #define HB_CPID_USASCII    "us-ascii"
constexpr const char *HB_CPID_646YU = "iso646-yu"; // #define HB_CPID_646YU      "iso646-yu"
constexpr const char *HB_CPID_646YUC = "iso646-yuc"; // #define HB_CPID_646YUC     "iso646-yuc"
#else
...
extern HB_EXPORT HB_CODEPAGE *hb_vmCDP(void);
extern HB_EXPORT void hb_vmSetCDP(HB_CODEPAGE *pCDP);
...
extern HB_EXPORT HB_BOOL hb_cdpRegisterRaw(HB_CODEPAGE *cdp);
...
extern HB_EXPORT HB_BOOL hb_cdpIsUTF8(HB_CODEPAGE *cdp);
extern HB_EXPORT HB_CODEPAGE *hb_cdpSelect(HB_CODEPAGE *cdp);
extern HB_EXPORT const char *hb_cdpSelectID(const char *id);
extern HB_EXPORT HB_CODEPAGE *hb_cdpFind(const char *id);
extern HB_EXPORT HB_CODEPAGE *hb_cdpFindExt(const char *id);
...
extern HB_EXPORT const HB_UCHAR *hb_cdpGetSortTab(HB_CODEPAGE *cdp);

extern HB_EXPORT char *hb_cdpDup(const char *, HB_CODEPAGE *, HB_CODEPAGE *);
extern HB_EXPORT char *hb_cdpDupn(const char *, HB_SIZE, HB_CODEPAGE *, HB_CODEPAGE *);
extern HB_EXPORT char *hb_cdpnDup(const char *, HB_SIZE *, HB_CODEPAGE *, HB_CODEPAGE *);
extern HB_EXPORT const char *hb_cdpnDup2(const char *, HB_SIZE, char *, HB_SIZE *, HB_CODEPAGE *, HB_CODEPAGE *);
extern HB_EXPORT const char *hb_cdpnDup3(const char *, HB_SIZE, char *, HB_SIZE *, char **, HB_SIZE *, HB_CODEPAGE *, HB_CODEPAGE *);
extern HB_EXPORT HB_SIZE hb_cdpnDupLen(const char *, HB_SIZE, HB_CODEPAGE *, HB_CODEPAGE *);
extern HB_EXPORT HB_SIZE hb_cdpnDup2Len(const char *, HB_SIZE, HB_SIZE, HB_CODEPAGE *, HB_CODEPAGE *);

extern HB_EXPORT char *hb_cdpnDupUpper(HB_CODEPAGE *cdp, const char *pszText, HB_SIZE *pnSize);
extern HB_EXPORT char *hb_cdpnDupLower(HB_CODEPAGE *cdp, const char *pszText, HB_SIZE *pnSize);
extern HB_EXPORT HB_SIZE hb_cdpnDup2Upper(HB_CODEPAGE *cdp, const char *pszText, HB_SIZE nSize, char *buffer, HB_SIZE nBuffLen);
extern HB_EXPORT HB_SIZE hb_cdpnDup2Lower(HB_CODEPAGE *cdp, const char *pszText, HB_SIZE nSize, char *buffer, HB_SIZE nBuffLen);

extern HB_EXPORT HB_SIZE hb_cdpTransLen(const char *pSrc, HB_SIZE nSrc, HB_SIZE nMax, HB_CODEPAGE *cdpIn, HB_CODEPAGE *cdpOut);
extern HB_EXPORT HB_SIZE hb_cdpTransTo(const char *pSrc, HB_SIZE nSrc, char *pDst, HB_SIZE nDst, HB_CODEPAGE *cdpIn, HB_CODEPAGE *cdpOut);

extern HB_EXPORT HB_WCHAR hb_cdpGetU16Disp(HB_CODEPAGE *cdp, HB_UCHAR ch);
...
extern HB_EXPORT HB_UCHAR hb_cdpGetChar(HB_CODEPAGE *cdp, HB_WCHAR wc);
extern HB_EXPORT HB_WCHAR hb_cdpGetU16(HB_CODEPAGE *cdp, HB_UCHAR ch);
extern HB_EXPORT HB_UCHAR hb_cdpGetUC(HB_CODEPAGE *cdp, HB_WCHAR wc, HB_UCHAR ucDef);
extern HB_EXPORT HB_WCHAR hb_cdpGetWC(HB_CODEPAGE *cdp, HB_UCHAR ch, HB_WCHAR wcDef);

extern HB_EXPORT HB_BOOL hb_cdpGetFromUTF8(HB_CODEPAGE *cdp, HB_UCHAR ch, int *n, HB_WCHAR *pwc);
...
extern HB_EXPORT HB_SIZE hb_cdpUTF8AsStrLen(HB_CODEPAGE *cdp, const char *pSrc, HB_SIZE nSrc, HB_SIZE nMax);
extern HB_EXPORT HB_SIZE hb_cdpUTF8ToStr(HB_CODEPAGE *cdp, const char *pSrc, HB_SIZE nSrc, char *pDst, HB_SIZE nDst);
extern HB_EXPORT HB_SIZE hb_cdpStrAsUTF8Len(HB_CODEPAGE *cdp, const char *pSrc, HB_SIZE nSrc, HB_SIZE nMax);
...
extern HB_EXPORT HB_SIZE hb_cdpTextLen(HB_CODEPAGE *cdp, const char *pText, HB_SIZE nSize);
extern HB_EXPORT HB_SIZE hb_cdpTextPos(HB_CODEPAGE *cdp, const char *pText, HB_SIZE nSize, HB_SIZE nIndex);
extern HB_EXPORT HB_SIZE hb_cdpTextPosEx(HB_CODEPAGE *cdp, const char *pText, HB_SIZE nSize, HB_SIZE *pnIndex);

extern HB_EXPORT HB_WCHAR hb_cdpTextGetU16(HB_CODEPAGE *cdp, const char *szText, HB_SIZE nLen);
extern HB_EXPORT HB_SIZE hb_cdpTextPutU16(HB_CODEPAGE *cdp, char *szText, HB_SIZE nSize, HB_WCHAR wc);
extern HB_EXPORT HB_BOOL hb_cdpCharEq(HB_CODEPAGE *cdp, const char *szText1, HB_SIZE nLen1, HB_SIZE *pnPos1,
                                      const char *szText2, HB_SIZE nLen2, HB_SIZE *pnPos2);
extern HB_EXPORT HB_BOOL hb_cdpCharCaseEq(HB_CODEPAGE *cdp, const char *szText1, HB_SIZE nLen1, HB_SIZE *pnPos1,
                                          const char *szText2, HB_SIZE nLen2, HB_SIZE *pnPos2);
