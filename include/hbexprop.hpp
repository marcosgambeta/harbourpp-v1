...
extern HB_EXPORT_INT PHB_EXPR hb_compExprNewDouble( double, uint8_t, uint8_t, HB_COMP_DECL );
...
extern HB_EXPORT_INT PHB_EXPR hb_compExprNewLogical( int32_t iValue, HB_COMP_DECL );
extern HB_EXPORT_INT PHB_EXPR hb_compExprNewSelf( HB_COMP_DECL );
extern HB_EXPORT_INT PHB_EXPR hb_compExprNewCodeBlock( char * string, HB_SIZE nLen, int32_t iFlags, HB_COMP_DECL );
...
extern HB_EXPORT_INT PHB_EXPR hb_compExprCBVarAdd( PHB_EXPR, const char * szVarName, uint8_t bType, HB_COMP_DECL );
...
extern HB_EXPORT_INT PHB_EXPR hb_compExprSetCodeblockBody( PHB_EXPR pExpr, uint8_t * pCode, HB_SIZE nLen );
...
extern HB_EXPORT_INT int32_t hb_compExprType( PHB_EXPR );
extern HB_EXPORT_INT int32_t hb_compExprIsInteger( PHB_EXPR );
extern HB_EXPORT_INT int32_t hb_compExprIsLong( PHB_EXPR );
extern HB_EXPORT_INT int32_t hb_compExprAsInteger( PHB_EXPR );
extern HB_EXPORT_INT int32_t hb_compExprAsNumSign( PHB_EXPR );
extern HB_EXPORT_INT int32_t hb_compExprIsString( PHB_EXPR );
...
extern HB_EXPORT_INT HB_BOOL hb_compExprReduceSTOT( PHB_EXPR, uint16_t usCount, HB_COMP_DECL );
extern HB_EXPORT_INT HB_BOOL hb_compExprReduceSTOD( PHB_EXPR, uint16_t usCount, HB_COMP_DECL );
