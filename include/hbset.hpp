...
typedef struct
{
   ...
   int32_t        HB_SET_AUTORDER;
   int32_t        HB_SET_AUTOSHARE;
   HB_BOOL    HB_SET_BELL;
   ...
   char *     HB_SET_DEVICE;
   HB_BOOL    HB_SET_EOF;
   int32_t        HB_SET_EPOCH;
   HB_BOOL    HB_SET_ESCAPE;
   int32_t        HB_SET_EVENTMASK;
   ...
   char *     HB_SET_PATH;
   int32_t        HB_SET_MARGIN;
   int32_t        HB_SET_MBLOCKSIZE;
   HB_BOOL    HB_SET_MCENTER;
   int32_t        HB_SET_MESSAGE;
   ...
   int32_t        HB_SET_TYPEAHEAD;
   HB_BOOL    HB_SET_UNIQUE;
   int32_t        HB_SET_FILECASE;
   int32_t        HB_SET_DIRCASE;
   int32_t        HB_SET_DIRSEPARATOR;
   int32_t        HB_SET_VIDEOMODE;
   HB_BOOL    HB_SET_WRAP;
   int32_t        HB_SET_DBFLOCKSCHEME;
...
extern HB_EXPORT int32_t          hb_setListenerAdd( HB_SET_LISTENER_CALLBACK * );
extern HB_EXPORT void         hb_setListenerNotify( HB_set_enum, HB_set_listener_enum );
extern HB_EXPORT int32_t          hb_setListenerRemove( int32_t );
...
extern HB_EXPORT int32_t          hb_setUpdateEpoch( int32_t iYear );

extern HB_EXPORT HB_BOOL      hb_setGetCentury( void );
extern HB_EXPORT HB_BOOL      hb_setSetCentury( HB_BOOL );

extern HB_EXPORT int32_t          hb_setGetFileCase( void );
extern HB_EXPORT void         hb_setSetFileCase( int32_t iFileCase );

extern HB_EXPORT int32_t          hb_setGetDirCase( void );
extern HB_EXPORT void         hb_setSetDirCase( int32_t iDirCase );

extern HB_EXPORT int32_t          hb_setGetDirSeparator( void );
extern HB_EXPORT void         hb_setSetDirSeparator( int32_t iSeparator );
...
extern HB_EXPORT PHB_FILE     hb_setGetPrinterHandle( int32_t );
...
extern HB_EXPORT int32_t          hb_setGetAutOrder( void );
extern HB_EXPORT int32_t          hb_setGetAutoShare( void );
...
extern HB_EXPORT int32_t          hb_setGetDecimals( void );
...
extern HB_EXPORT int32_t          hb_setGetEpoch( void );
extern HB_EXPORT HB_BOOL      hb_setGetEscape( void );
extern HB_EXPORT int32_t          hb_setGetEventMask( void );
...
extern HB_EXPORT int32_t          hb_setGetMargin( void );
extern HB_EXPORT int32_t          hb_setGetMBlockSize( void );
extern HB_EXPORT HB_BOOL      hb_setGetMCenter( void );
extern HB_EXPORT int32_t          hb_setGetMessage( void );
...
extern HB_EXPORT int32_t          hb_setGetTypeAhead( void );
extern HB_EXPORT HB_BOOL      hb_setGetUnique( void );
extern HB_EXPORT int32_t          hb_setGetVideoMode( void );
extern HB_EXPORT HB_BOOL      hb_setGetWrap( void );
extern HB_EXPORT int32_t          hb_setGetDBFLockScheme( void );
