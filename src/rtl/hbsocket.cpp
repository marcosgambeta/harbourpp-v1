...
static const char *s_socketErrors[] = {"OK",
                                       "EPIPE",
                                       "ETIMEOUT",
                                       "EWRONGADDR",
                                       "EAFNOSUPPORT",
...
int32_t hb_socketGetError(void)
{
  return hb_stackIOErrors()->uiSocketError;
}

int32_t hb_socketGetOsError(void)
{
  return hb_stackIOErrors()->iSocketOsError;
}

const char *hb_socketErrorStr(int32_t iError)
{
...
void hb_socketSetError(int32_t err)
{
  PHB_IOERRORS pError = hb_stackIOErrors();
  pError->uiSocketError = static_cast<HB_ERRCODE>(err);
  pError->iSocketOsError = 0;
}

#if defined(HB_SOCKET_OFF)

int32_t hb_socketInit(void)
{
  return -1;
}
...
int32_t hb_socketGetAddrFamily(const void *pSockAddr, unsigned len)
{
...
HB_BOOL hb_socketInetAddr(void **pSockAddr, unsigned *puiLen, const char *szAddr, int32_t iPort)
{
  HB_SYMBOL_UNUSED(szAddr);
...
HB_BOOL hb_socketInet6Addr(void **pSockAddr, unsigned *puiLen, const char *szAddr, int32_t iPort)
{
  HB_SYMBOL_UNUSED(szAddr);
  HB_SYMBOL_UNUSED(iPort);
  hb_socketSetError(HB_SOCKET_ERR_AFNOSUPPORT);
...
int32_t hb_socketAddrGetPort(const void *pSockAddr, unsigned len)
{
  HB_SYMBOL_UNUSED(pSockAddr);
  HB_SYMBOL_UNUSED(len);
  hb_socketSetError(HB_SOCKET_ERR_AFNOSUPPORT);
...
int32_t hb_socketGetSockName(HB_SOCKET sd, void **pSockAddr, unsigned *puiLen)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketGetPeerName(HB_SOCKET sd, void **pSockAddr, unsigned *puiLen)
{
  HB_SYMBOL_UNUSED(sd);
  hb_socketSetError(HB_SOCKET_ERR_INVALIDHANDLE);
  *pSockAddr = nullptr;
...
HB_SOCKET hb_socketOpen(int32_t domain, int32_t type, int32_t protocol)
{
...
int32_t hb_socketClose(HB_SOCKET sd)
{
  HB_SYMBOL_UNUSED(sd);
  hb_socketSetError(HB_SOCKET_ERR_INVALIDHANDLE);
  return -1;
...
int32_t hb_socketShutdown(HB_SOCKET sd, int32_t iMode)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketBind(HB_SOCKET sd, const void *pSockAddr, unsigned uiLen)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(pSockAddr);
...
int32_t hb_socketListen(HB_SOCKET sd, int32_t iBacklog)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketConnect(HB_SOCKET sd, const void *pSockAddr, unsigned uiLen, HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(pSockAddr);
  HB_SYMBOL_UNUSED(uiLen);
...
long hb_socketSend(HB_SOCKET sd, const void *data, long len, int32_t flags, HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
...
long hb_socketSendTo(HB_SOCKET sd, const void *data, long len, int32_t flags, const void *pSockAddr, unsigned uiSockLen,
                     HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(data);
...
long hb_socketRecv(HB_SOCKET sd, void *data, long len, int32_t flags, HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(data);
  HB_SYMBOL_UNUSED(len);
...
long hb_socketRecvFrom(HB_SOCKET sd, void *data, long len, int32_t flags, void **pSockAddr, unsigned *puiSockLen,
                       HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(data);
...
int32_t hb_socketSetBlockingIO(HB_SOCKET sd, HB_BOOL fBlocking)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetNoDelay(HB_SOCKET sd, HB_BOOL fNoDelay)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetNoSigPipe(HB_SOCKET sd, HB_BOOL fNoSigPipe)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetExclusiveAddr(HB_SOCKET sd, HB_BOOL fExclusive)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetReuseAddr(HB_SOCKET sd, HB_BOOL fReuse)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetKeepAlive(HB_SOCKET sd, HB_BOOL fKeepAlive)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetBroadcast(HB_SOCKET sd, HB_BOOL fBroadcast)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetSndBufSize(HB_SOCKET sd, int32_t iSize)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetRcvBufSize(HB_SOCKET sd, int32_t iSize)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(iSize);
  hb_socketSetError(HB_SOCKET_ERR_INVALIDHANDLE);
...
int32_t hb_socketGetSndBufSize(HB_SOCKET sd, int32_t *piSize)
{
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketGetRcvBufSize(HB_SOCKET sd, int32_t *piSize)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(piSize);
  hb_socketSetError(HB_SOCKET_ERR_INVALIDHANDLE);
...
int32_t hb_socketSetMulticast(HB_SOCKET sd, int32_t af, const char *szAddr)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(af);
  HB_SYMBOL_UNUSED(szAddr);
...
int32_t hb_socketSelectRead(HB_SOCKET sd, HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(timeout);
  hb_socketSetError(HB_SOCKET_ERR_INVALIDHANDLE);
...
int32_t hb_socketSelectWrite(HB_SOCKET sd, HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(timeout);
  hb_socketSetError(HB_SOCKET_ERR_INVALIDHANDLE);
...
int32_t hb_socketSelectWriteEx(HB_SOCKET sd, HB_MAXINT timeout)
{
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(timeout);
  hb_socketSetError(HB_SOCKET_ERR_INVALIDHANDLE);
...
HB_BOOL hb_socketResolveInetAddr(void **pSockAddr, unsigned *puiLen, const char *szAddr, int32_t iPort)
{
  HB_SYMBOL_UNUSED(szAddr);
  HB_SYMBOL_UNUSED(iPort);
  hb_socketSetError(HB_SOCKET_ERR_AFNOSUPPORT);
...
char *hb_socketResolveAddr(const char *szAddr, int32_t af)
{
  HB_SYMBOL_UNUSED(szAddr);
  HB_SYMBOL_UNUSED(af);
  hb_socketSetError(HB_SOCKET_ERR_AFNOSUPPORT);
...
static int32_t s_iSessions;

#if defined(HB_HAS_INET6) && !defined(HB_HAS_INET6_ADDR_CONST) && defined(IN6ADDR_ANY_INIT)
...
static const char *hb_inet_ntoa(const struct in_addr *addr, char *pBuffer)
{
  ...
  hb_snprintf(pBuffer, INET_ADDRSTRLEN, "%hd.%hd.%hd.%hd", HB_UHBYTE(u), HB_ULBYTE(u), HB_HIBYTE(u), HB_LOBYTE(u));
  return pBuffer;
}
#endif
...
static void hb_socketSetOsError(int32_t err)
{
  PHB_IOERRORS pError = hb_stackIOErrors();
  HB_ERRCODE uiErr;
...
#if !defined(HB_OS_WIN)
static void hb_socketSetResolveError(int32_t err)
{
  PHB_IOERRORS pError = hb_stackIOErrors();
  HB_ERRCODE uiErr;
...
static int32_t hb_socketTransDomain(int32_t domain, int32_t *err)
{
  switch (domain) {
...
static int32_t hb_socketTransType(int32_t type, int32_t *err)
{
  switch (type) {
...
static int32_t hb_socketTransFlags(int32_t flags)
{
  int32_t iResult = 0;
...
static int32_t hb_socketSelectRD(HB_SOCKET sd, HB_MAXINT timeout)
{
#if defined(HB_HAS_POLL)
  ...
  do {
    int32_t tout = timeout < 0 || timeout > 1000 ? 1000 : static_cast<int32_t>(timeout), iError;
  ...
  for (;;) {
    ...
    FD_ZERO(&rfds);
    FD_SET(static_cast<HB_SOCKET_T>(sd), &rfds);
    iResult = select(static_cast<int32_t>(sd + 1), &rfds, nullptr, nullptr, &tv);
    iError = iResult >= 0 ? 0 : HB_SOCK_GETERROR();
    hb_socketSetOsError(iError);
  ...
  return iResult < 0 ? -1 : (iResult > 0 && FD_ISSET(static_cast<HB_SOCKET_T>(sd), &rfds) ? 1 : 0);
#endif /* !HB_HAS_POLL */
}

static int32_t hb_socketSelectWR(HB_SOCKET sd, HB_MAXINT timeout)
{
#if defined(HB_HAS_POLL)
  HB_MAXUINT timer = hb_timerInit(timeout);
  struct pollfd fds;
  ...
  for (;;) {
    ...
    FD_ZERO(&wfds);
    FD_SET(static_cast<HB_SOCKET_T>(sd), &wfds);
    iResult = select(static_cast<int32_t>(sd + 1), nullptr, &wfds, nullptr, &tv);
    iError = iResult >= 0 ? 0 : HB_SOCK_GETERROR();
    hb_socketSetOsError(iError);
  ...
  return iResult < 0 ? -1 : (iResult > 0 && FD_ISSET(static_cast<HB_SOCKET_T>(sd), &wfds) ? 1 : 0);
#endif /* !HB_HAS_POLL */
}

static int32_t hb_socketSelectWRE(HB_SOCKET sd, HB_MAXINT timeout)
{
#if defined(HB_HAS_POLL)
  HB_MAXUINT timer = hb_timerInit(timeout);
  int32_t iResult, iError, tout;
  struct pollfd fds;
  ...
  do {
    tout = timeout < 0 || timeout > 1000 ? 1000 : static_cast<int32_t>(timeout);
    iResult = poll(&fds, 1, tout);
    iError = iResult >= 0 ? 0 : HB_SOCK_GETERROR();
    if (iResult > 0 && (fds.revents & POLLOUT) == 0) {
      if (fds.revents & POLLNVAL) {
...
#if defined(HB_OS_WIN)
    FD_ZERO(&efds);
    FD_SET(static_cast<HB_SOCKET_T>(sd), &efds);
    pefds = &efds;
#else
    pefds = nullptr;
#endif

    iResult = select(static_cast<int32_t>(sd + 1), nullptr, &wfds, pefds, &tv);
    iError = iResult >= 0 ? 0 : HB_SOCK_GETERROR();
    hb_socketSetOsError(iError);
#if defined(HB_OS_WIN)
    if (iResult > 0 && FD_ISSET(static_cast<HB_SOCKET_T>(sd), pefds)) {
      iResult = -1;
      len = sizeof(iError);
      if (getsockopt(sd, SOL_SOCKET, SO_ERROR, reinterpret_cast<char *>(&iError), &len) != 0) {
        iError = HB_SOCK_GETERROR();
...
int32_t hb_socketGetAddrFamily(const void *pSockAddr, unsigned len)
{
  return pSockAddr && len ? (static_cast<const struct sockaddr *>(pSockAddr))->sa_family : -1;
}
...
#if defined(HB_HAS_INET_PTON)
    int32_t err = inet_pton(AF_INET6, szAddr, &sa.sin6_addr);
    if (err > 0) {
      *pSockAddr = memcpy(hb_xgrab(sizeof(sa) + 1), &sa, sizeof(sa));
      *puiLen = static_cast<unsigned>(sizeof(sa));
      return true;
...
/* caller must free the buffer if not nullptr */
char *hb_socketAddrGetName(const void *pSockAddr, unsigned len)
{
  char *szName = nullptr;
...
int32_t hb_socketAddrGetPort(const void *pSockAddr, unsigned len)
{
  ...
  case AF_INET:
    if (len >= sizeof(struct sockaddr_in)) {
      iPort = ntohs((static_cast<const struct sockaddr_in *>(pSockAddr))->sin_port);
    }
    break;
#endif
#if defined(HB_HAS_INET6)
  case AF_INET6:
    if (len >= sizeof(struct sockaddr_in6)) {
      iPort = ntohs((static_cast<const struct sockaddr_in6 *>(pSockAddr))->sin6_port);
    }
    break;
#endif
#if defined(HB_HAS_UNIX)
...
HB_BOOL hb_socketAddrFromItem(void **pSockAddr, unsigned *puiLen, HB_ITEM *pAddrItm)
{
  ...
  *puiLen = 0;
  ...
  if (pAddrItm && pAddrItm->isArray()) {
    if (hb_arrayLen(pAddrItm) >= 2 && (hb_arrayGetType(pAddrItm, 1) & Harbour::Item::NUMERIC) != 0) {
      switch (hb_arrayGetNI(pAddrItm, 1)) {
      case HB_SOCKET_AF_INET:
        fOK = hb_socketInetAddr(pSockAddr, puiLen, hb_arrayGetCPtr(pAddrItm, 2), hb_arrayGetNI(pAddrItm, 3));
        break;
      case HB_SOCKET_AF_INET6:
        fOK = hb_socketInet6Addr(pSockAddr, puiLen, hb_arrayGetCPtr(pAddrItm, 2), hb_arrayGetNI(pAddrItm, 3));
        break;
      case HB_SOCKET_AF_LOCAL:
        fOK = hb_socketLocalAddr(pSockAddr, puiLen, hb_arrayGetCPtr(pAddrItm, 2));
        break;
      case HB_SOCKET_AF_PACKET:
      case HB_SOCKET_AF_IPX:
        break;
...
int32_t hb_socketBind(HB_SOCKET sd, const void *pSockAddr, unsigned uiLen)
{
  int32_t ret = bind(sd, static_cast<const struct sockaddr *>(pSockAddr), static_cast<socklen_t>(uiLen));
  hb_socketSetOsError(ret == 0 ? 0 : HB_SOCK_GETERROR());
  return ret;
}
...
int32_t hb_socketListen(HB_SOCKET sd, int32_t iBacklog)
{
  int32_t ret = listen(sd, iBacklog);
  hb_socketSetOsError(ret == 0 ? 0 : HB_SOCK_GETERROR());
  return ret;
}
...
HB_SOCKET hb_socketAccept(HB_SOCKET sd, void **pSockAddr, unsigned *puiLen, HB_MAXINT timeout)
{
  ...
  int32_t ret = hb_socketSelectRD(sd, timeout);
  if (ret > 0) {
    ...
    int32_t err = newsd != HB_NO_SOCKET ? 0 : HB_SOCK_GETERROR();
...
int32_t hb_socketConnect(HB_SOCKET sd, const void *pSockAddr, unsigned uiLen, HB_MAXINT timeout)
{
   ...
   */
  int32_t blk = timeout < 0 ? 0 : hb_socketSetBlockingIO(sd, false);
  int32_t ret = connect(sd, static_cast<const struct sockaddr *>(pSockAddr), static_cast<socklen_t>(uiLen));
  int32_t err = ret == 0 ? 0 : HB_SOCK_GETERROR();
  hb_socketSetOsError(err);
  ...
  if (blk > 0) {
    ...
    int32_t rawerr = err ? 0 : hb_socketGetError();
...
#endif
    do {
      lSent = sendto(sd, static_cast<const char *>(data), len, flags, static_cast<const struct sockaddr *>(pSockAddr),
                     static_cast<socklen_t>(uiSockLen));
      iError = lSent > 0 ? 0 : HB_SOCK_GETERROR();
      hb_socketSetOsError(iError);
    } while (lSent == -1 && HB_SOCK_IS_EINTR(iError) && hb_vmRequestQuery() == 0);
  }
...
int32_t hb_socketSetNoDelay(HB_SOCKET sd, HB_BOOL fNoDelay)
{
   ...
   */
  int32_t val = fNoDelay ? 1 : 0;
  int32_t ret = setsockopt(sd, IPPROTO_TCP, TCP_NODELAY, reinterpret_cast<const char *>(&val), sizeof(val));
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
#else
  int32_t iTODO;
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetNoSigPipe(HB_SOCKET sd, HB_BOOL fNoSigPipe)
{
  ...
  int32_t val = fNoSigPipe ? 1 : 0, ret;
...
int32_t hb_socketSetExclusiveAddr(HB_SOCKET sd, HB_BOOL fExclusive)
{
  ...
  int32_t val = fExclusive ? 1 : 0;
  int32_t ret = setsockopt(sd, SOL_SOCKET, SO_EXCLUSIVEADDRUSE, reinterpret_cast<const char *>(&val), sizeof(val));
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
#else
  HB_SYMBOL_UNUSED(sd);
  HB_SYMBOL_UNUSED(fExclusive);
...
int32_t hb_socketSetKeepAlive(HB_SOCKET sd, HB_BOOL fKeepAlive)
{
  int32_t val = fKeepAlive ? 1 : 0;
  int32_t ret = setsockopt(sd, SOL_SOCKET, SO_KEEPALIVE, reinterpret_cast<const char *>(&val), sizeof(val));
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
  return ret;
}
...
int32_t hb_socketSetBroadcast(HB_SOCKET sd, HB_BOOL fBroadcast)
{
  ...
  int32_t val = fBroadcast ? 1 : 0;
  int32_t ret = setsockopt(sd, SOL_SOCKET, SO_BROADCAST, reinterpret_cast<const char *>(&val), sizeof(val));
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
  return ret;
#else
  HB_SYMBOL_UNUSED(sd);
...
int32_t hb_socketSetSndBufSize(HB_SOCKET sd, int32_t iSize)
{
  int32_t ret = setsockopt(sd, SOL_SOCKET, SO_SNDBUF, reinterpret_cast<const char *>(&iSize), sizeof(iSize));
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
  return ret;
}
...
int32_t hb_socketSetRcvBufSize(HB_SOCKET sd, int32_t iSize)
{
  int32_t ret = setsockopt(sd, SOL_SOCKET, SO_RCVBUF, reinterpret_cast<const char *>(&iSize), sizeof(iSize));
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
  return ret;
}
...
int32_t hb_socketGetSndBufSize(HB_SOCKET sd, int32_t *piSize)
{
  ...
  int32_t ret = getsockopt(sd, SOL_SOCKET, SO_SNDBUF, reinterpret_cast<char *>(piSize), &len);
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
  return ret;
}
...
{
  socklen_t len = sizeof(*piSize);
  int32_t ret = getsockopt(sd, SOL_SOCKET, SO_RCVBUF, reinterpret_cast<char *>(piSize), &len);
  hb_socketSetOsError(ret != -1 ? 0 : HB_SOCK_GETERROR());
  return ret;
}
...
int32_t hb_socketSetMulticast(HB_SOCKET sd, int32_t af, const char *szAddr)
{
  if (af == HB_SOCKET_AF_INET) {
    ...
    ret =
        (mreq.imr_multiaddr.s_addr != INADDR_NONE || strcmp("255.255.255.255", szAddr) == 0) ? 0 : -1; /* dirty hack */
#endif
    ...
    int32_t err = inet_pton(AF_INET6, szAddr, &mreq.ipv6mr_multiaddr);
    if (err > 0) {
      int32_t ret;
...
{
  hb_vmUnlock();
  int32_t ret = hb_socketSelectWR(sd, timeout);
  hb_vmLock();
  return ret;
}
...
{
  hb_vmUnlock();
  int32_t ret = hb_socketSelectWRE(sd, timeout);
  hb_vmLock();
  return ret;
}
...
static HB_SOCKET s_socketSelectCallback(HB_ITEM *pItem)
{
  ...
  if (pItem != nullptr) {
    if (pItem->isNumeric()) {
      sd = static_cast<HB_SOCKET>(pItem->getNInt());
...
#if defined(HB_HAS_POLL)
static int32_t s_socketPollCheck(HB_SOCKET sd, struct pollfd *pfds, nfds_t nfds)
{
  for (nfds_t npos = 0; npos < nfds; ++npos) {
    if (pfds[npos].fd == sd) {
      return static_cast<int32_t>(npos);
    }
  }
  return -1;
}
                    ...
                    HB_BOOL fSetEX, HB_MAXINT timeout, HB_SOCKET_FUNC pFunc)
{
  ...
  do {
    ...
    ret = select(static_cast<int32_t>(maxsd + 1), pfds[0], pfds[1], pfds[2], &tv);
    ...
    hb_vmLock();
  } while (ret == 0 && (timeout = hb_timerTest(timeout, &timer)) != 0 && hb_vmRequestQuery() == 0);
...
HB_BOOL hb_socketResolveInetAddr(void **pSockAddr, unsigned *puiLen, const char *szAddr, int32_t iPort)
{
  ...
  if (!fTrans) {
    ...
    iError = getaddrinfo(szAddr, nullptr, &hints, &res);
    hb_socketSetResolveError(iError);
    if (iError == 0) {
      if (static_cast<int32_t>(res->ai_addrlen) >= static_cast<int32_t>(sizeof(struct sockaddr_in)) &&
...
HB_ITEM *hb_socketGetHosts(const char *szAddr, int32_t af)
{
  ...
  memset(&hints, 0, sizeof(hints));
  hints.ai_family = af;
  iResult = getaddrinfo(szAddr, nullptr, &hints, &res);
...
{
  char *szResult = nullptr;
  int32_t af = hb_socketGetAddrFamily(pSockAddr, len);
...
#define NI_MAXHOST 1025
    ...
    hb_vmUnlock();
    iResult = getnameinfo(static_cast<const struct sockaddr *>(pSockAddr), len, szHost, NI_MAXHOST, nullptr, 0, 0);
    hb_socketSetResolveError(iResult);
    hb_vmLock();
    if (iResult == 0) {
...
#endif
#if defined(SIOCGIFCONF) && defined(HB_OS_BSD) && !defined(SIOCGIFHWADDR) && !defined(SIOCGENADDR)
static char *hb_getMAC(const char *pszIfName)
{
  ...
  if (getifaddrs(&ifap) == 0 && ifap) {
    ...
    while (ifa != nullptr) {
      if (ifa->ifa_addr != nullptr && ifa->ifa_addr->sa_family == AF_LINK && ifa->ifa_name &&
          strcmp(ifa->ifa_name, pszIfName) == 0) {
        auto sdl = reinterpret_cast<struct sockaddr_dl *>(ifa->ifa_addr);
        auto data = reinterpret_cast<unsigned char *>(LLADDR(sdl));
        char hwaddr[24];

        hb_snprintf(hwaddr, sizeof(hwaddr), "%02X:%02X:%02X:%02X:%02X:%02X", data[0], data[1], data[2], data[3],
                    data[4], data[5]);
 ...
 */
  ...
  if (sd != HB_NO_SOCKET) {
    ...
    int32_t len = 0, size, iLastName = 0, iLastFamily = 0, flags, family;
    ...
    if (ioctl(sd, SIOCGIFCONF, &ifc) != -1) {
      for (ptr = static_cast<char *>(ifc.ifc_buf), size = ifc.ifc_len; size > 0;) {
        ...
        if (len < static_cast<int32_t>(sizeof(struct sockaddr))) {
...
#if !defined(HB_OS_BEOS)
        if (len < static_cast<int32_t>(sizeof(struct ifreq))) {
          len = static_cast<int32_t>(sizeof(struct ifreq));
        }
#endif
        ptr += len;
        size -= len;
        ...
        if (fNoAliases) {
          ...
          len = cptr ? static_cast<int32_t>(cptr - pifr->ifr_name) : static_cast<int32_t>(strlen(pifr->ifr_name));
        ...
        if (len) {
          hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_ADDR, &pifr->ifr_addr, len);
...
#define ifr_netmask ifr_addr
          ...
          if (ioctl(sd, SIOCGIFNETMASK, pifr) != -1) {
            hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_NETMASK, &pifr->ifr_netmask, len);
          }
#endif
#if defined(SIOCGIFBRDADDR)
          if (flags & IFF_BROADCAST) {
            if (ioctl(sd, SIOCGIFBRDADDR, pifr) != -1) {
              hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_BROADCAST, &pifr->ifr_broadaddr, len);
            }
          }
#endif
          ...
          if (flags & IFF_POINTOPOINT) {
            if (ioctl(sd, SIOCGIFDSTADDR, pifr) != -1) {
              hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_P2PADDR, &pifr->ifr_dstaddr, len);
            }
          }
#endif
...
#define ifr_hwaddr ifr_addr
        ...
        flags = ((flags & IFF_UP) ? HB_SOCKET_IFF_UP : 0) | ((flags & IFF_BROADCAST) ? HB_SOCKET_IFF_BROADCAST : 0) |
                ((flags & IFF_LOOPBACK) ? HB_SOCKET_IFF_LOOPBACK : 0) |
                ((flags & IFF_POINTOPOINT) ? HB_SOCKET_IFF_POINTOPOINT : 0) |
                ((flags & IFF_MULTICAST) ? HB_SOCKET_IFF_MULTICAST : 0);
  ...
  if (sd != HB_NO_SOCKET) {
    ...
    if (WSAIoctl(sd, SIO_GET_INTERFACE_LIST, nullptr, 0, pIfInfo, dwBuffer, &dwBuffer, 0, 0) != SOCKET_ERROR) {
      int32_t iCount = dwBuffer / sizeof(INTERFACE_INFO);
      ...
      while (iCount--) {
        ...
        if (flags & IFF_UP) {
          ...
          hb_arraySetNI(pItem, HB_SOCKET_IFINFO_FAMILY, pIfInfo->iiAddress.Address.sa_family);

          hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_ADDR, &pIfInfo->iiAddress, sizeof(pIfInfo->iiAddress));
          hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_NETMASK, &pIfInfo->iiNetmask, sizeof(pIfInfo->iiNetmask));
          if (flags & IFF_BROADCAST) {
            hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_BROADCAST, &pIfInfo->iiBroadcastAddress,
                                      sizeof(pIfInfo->iiBroadcastAddress));
          }
          if (flags & IFF_POINTTOPOINT) {
            hb_socketArraySetInetAddr(pItem, HB_SOCKET_IFINFO_P2PADDR, &pIfInfo->iiBroadcastAddress,
                                      sizeof(pIfInfo->iiBroadcastAddress));
          }

          flags = ((flags & IFF_UP) ? HB_SOCKET_IFF_UP : 0) | ((flags & IFF_BROADCAST) ? HB_SOCKET_IFF_BROADCAST : 0) |
                  ((flags & IFF_LOOPBACK) ? HB_SOCKET_IFF_LOOPBACK : 0) |
                  ((flags & IFF_POINTTOPOINT) ? HB_SOCKET_IFF_POINTOPOINT : 0) |
                  ((flags & IFF_MULTICAST) ? HB_SOCKET_IFF_MULTICAST : 0);
          hb_arraySetNI(pItem, HB_SOCKET_IFINFO_FLAGS, flags);
           ...
           */
          hb_arraySet(pItem, HB_SOCKET_IFINFO_NAME, hb_arrayGetItemPtr(pItem, HB_SOCKET_IFINFO_ADDR));
              ...
              while ((nPos = hb_socketArrayFindInetAddr(pIpAddress->IpAddress.String, pArray, nPos + 1)) != 0) {
                ...
                if (!hb_arrayGetCPtr(pIfItem, HB_SOCKET_IFINFO_HWADDR)[0]) {
                  ...
                  for (count = 0; count < pAdapter->AddressLength; ++count) {
                    ...
                    size += hb_snprintf(hwaddr + size, sizeof(hwaddr) - size, "%02X",
                                        static_cast<int32_t>(pAdapter->Address[count]));
                  }
