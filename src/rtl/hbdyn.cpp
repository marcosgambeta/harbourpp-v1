...
static HB_U64 hb_u64par(PHB_ITEM pParam, PHB_DYNARG pArg)
{
  ...
  case HB_DYN_CTYPE_SHORT:
    pArg->value.t.n64 = static_cast<short>(hb_itemGetNI(pParam));
    r = pArg->bByRef ? reinterpret_cast<uintptr_t>(&pArg->value.t.n64) : pArg->value.t.n64;
    break;

  case HB_DYN_CTYPE_SHORT_UNSIGNED:
    pArg->value.t.n64 = static_cast<unsigned short>(hb_itemGetNI(pParam));
    r = pArg->bByRef ? reinterpret_cast<uintptr_t>(&pArg->value.t.n64) : pArg->value.t.n64;
    break;
  ...
  case HB_DYN_CTYPE_LONG_UNSIGNED:
    pArg->value.t.n64 = static_cast<unsigned long>(hb_itemGetNInt(pParam));
    r = pArg->bByRef ? reinterpret_cast<uintptr_t>(&pArg->value.t.n64) : pArg->value.t.n64;
    break;
  ...
  case HB_DYN_CTYPE_DOUBLE:
    HB_PUT_LE_DOUBLE(reinterpret_cast<uint8_t *>(&pArg->value.t.n64), hb_itemGetND(pParam));
    r = pArg->bByRef ? reinterpret_cast<uintptr_t>(&pArg->value.t.n64) : pArg->value.t.n64;
    break;
  ...
  case HB_DYN_CTYPE_STRUCTURE: {
    ...
    r = reinterpret_cast<uintptr_t>(pArg->hString);
    pArg->value.t.n64 = r;
    break;
  }
  case HB_DYN_CTYPE_CHAR_PTR:
    ...
    case HB_DYN_ENC_ASCII: {
      ...
      r = reinterpret_cast<uintptr_t>(hb_strunshare(&pArg->hString, s, nLen));
      break;
    }
    ...
    case HB_DYN_ENC_UTF16: {
      ...
      r = reinterpret_cast<uintptr_t>(hb_wstrunshare(&pArg->hString, s, nLen));
      break;
    }
    default: {
      auto nLen = hb_itemGetCLen(pParam);
  ...
  case HB_DYN_CTYPE_STRUCTURE_PTR:
    pArg->value.t.n64 = reinterpret_cast<uintptr_t>(hb_itemGetPtr(pParam));
    r = pArg->bByRef ? reinterpret_cast<uintptr_t>(&pArg->value.t.n64) : pArg->value.t.n64;
    break;
...
#define HB_DYN_FUN_CALL(pcount, _ret_, _type_)                                                                         \
  do {                                                                                                                 \
    switch (pcount) {                                                                                                  \
    case 0:                                                                                                            \
      ret.t._ret_ = ((_type_##P00) * pFunction)();                                                                     \
      break;                                                                                                           \
    case 1:                                                                                                            \
      ret.t._ret_ = ((_type_##P01) * pFunction)(rawpar[0]);                                                            \
      break;                                                                                                           \
    case 2:                                                                                                            \
      ret.t._ret_ = ((_type_##P02) * pFunction)(rawpar[0], rawpar[1]);                                                 \
      break;                                                                                                           \
    case 3:                                                                                                            \
      ret.t._ret_ = ((_type_##P03) * pFunction)(rawpar[0], rawpar[1], rawpar[2]);                                      \
      break;                                                                                                           \
    case 4:                                                                                                            \
      ret.t._ret_ = ((_type_##P04) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3]);                           \
      break;                                                                                                           \
    case 5:                                                                                                            \
      ret.t._ret_ = ((_type_##P05) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4]);                \
      break;                                                                                                           \
    case 6:                                                                                                            \
      ret.t._ret_ = ((_type_##P06) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5]);     \
      break;                                                                                                           \
    case 7:                                                                                                            \
      ret.t._ret_ =                                                                                                    \
          ((_type_##P07) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6]);    \
      break;                                                                                                           \
    case 8:                                                                                                            \
      ret.t._ret_ = ((_type_##P08) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7]);                                                 \
      break;                                                                                                           \
    case 9:                                                                                                            \
      ret.t._ret_ = ((_type_##P09) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8]);                                      \
      break;                                                                                                           \
    case 10:                                                                                                           \
      ret.t._ret_ = ((_type_##P10) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9]);                           \
      break;                                                                                                           \
    case 11:                                                                                                           \
      ret.t._ret_ = ((_type_##P11) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10]);               \
      break;                                                                                                           \
    case 12:                                                                                                           \
      ret.t._ret_ = ((_type_##P12) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11]);   \
      break;                                                                                                           \
    case 13:                                                                                                           \
      ret.t._ret_ =                                                                                                    \
          ((_type_##P13) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6],     \
                                      rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11], rawpar[12]);            \
      break;                                                                                                           \
    case 14:                                                                                                           \
      ret.t._ret_ = ((_type_##P14) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11],    \
                                                rawpar[12], rawpar[13]);                                               \
      break;                                                                                                           \
    case 15:                                                                                                           \
      ret.t._ret_ = ((_type_##P15) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11],    \
                                                rawpar[12], rawpar[13], rawpar[14]);                                   \
      break;                                                                                                           \
    }                                                                                                                  \
  } while (false)
...
static void hb_u32par(PHB_ITEM pParam, PHB_DYNARG pArg, HB_U32 *r1, HB_U32 *r2, bool *b64)
{
  ...
  *r2 = 0;
  ...
  case HB_DYN_CTYPE_STRUCTURE: {
    ...
    memcpy(static_cast<char *>(pArg->hString), hb_itemGetCPtr(pParam), nLen);
    (static_cast<char *>(pArg->hString))[nLen] = '\0';
    *r1 = reinterpret_cast<uintptr_t>(pArg->hString);
    pArg->value.t.n32 = *r1;
    break;
  }
  case HB_DYN_CTYPE_CHAR_PTR:
...
#define HB_DYN_FUN_CALL(pcount, _ret_, _type_)                                                                         \
  do {                                                                                                                 \
    ...
    case 15:                                                                                                           \
      ...
      break;                                                                                                           \
    case 16:                                                                                                           \
      ret.t._ret_ = ((_type_##P16) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11],    \
                                                rawpar[12], rawpar[13], rawpar[14], rawpar[15]);                       \
      break;                                                                                                           \
    case 17:                                                                                                           \
      ret.t._ret_ = ((_type_##P17) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11],    \
                                                rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16]);           \
      break;                                                                                                           \
    case 18:                                                                                                           \
      ret.t._ret_ = ((_type_##P18) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17]);  \
      break;                                                                                                           \
    case 19:                                                                                                           \
      ret.t._ret_ =                                                                                                    \
          ((_type_##P19) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6],     \
                                      rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], \
                                      rawpar[14], rawpar[15], rawpar[16], rawpar[17], rawpar[18]);                     \
      break;                                                                                                           \
    case 20:                                                                                                           \
      ret.t._ret_ =                                                                                                    \
          ((_type_##P20) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6],     \
                                      rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], \
                                      rawpar[14], rawpar[15], rawpar[16], rawpar[17], rawpar[18], rawpar[19]);         \
      break;                                                                                                           \
    case 21:                                                                                                           \
      ret.t._ret_ = ((_type_##P21) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11],    \
                                                rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16],            \
                                                rawpar[17], rawpar[18], rawpar[19], rawpar[20]);                       \
      break;                                                                                                           \
    case 22:                                                                                                           \
      ret.t._ret_ = ((_type_##P22) * pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5],      \
                                                rawpar[6], rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11],    \
                                                rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16],            \
                                                rawpar[17], rawpar[18], rawpar[19], rawpar[20], rawpar[21]);           \
      break;                                                                                                           \
    case 23:                                                                                                           \
      ret.t._ret_ = ((_type_##P23) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17],   \
          rawpar[18], rawpar[19], rawpar[20], rawpar[21], rawpar[22]);                                                 \
      break;                                                                                                           \
    case 24:                                                                                                           \
      ret.t._ret_ = ((_type_##P24) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17],   \
          rawpar[18], rawpar[19], rawpar[20], rawpar[21], rawpar[22], rawpar[23]);                                     \
      break;                                                                                                           \
    case 25:                                                                                                           \
      ret.t._ret_ = ((_type_##P25) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17],   \
          rawpar[18], rawpar[19], rawpar[20], rawpar[21], rawpar[22], rawpar[23], rawpar[24]);                         \
      break;                                                                                                           \
    case 26:                                                                                                           \
      ret.t._ret_ = ((_type_##P26) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17],   \
          rawpar[18], rawpar[19], rawpar[20], rawpar[21], rawpar[22], rawpar[23], rawpar[24], rawpar[25]);             \
      break;                                                                                                           \
    case 27:                                                                                                           \
      ret.t._ret_ = ((_type_##P27) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17],   \
          rawpar[18], rawpar[19], rawpar[20], rawpar[21], rawpar[22], rawpar[23], rawpar[24], rawpar[25], rawpar[26]); \
      break;                                                                                                           \
    case 28:                                                                                                           \
      ret.t._ret_ = ((_type_##P28) *                                                                                   \
                     pFunction)(rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6],           \
                                rawpar[7], rawpar[8], rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13],       \
                                rawpar[14], rawpar[15], rawpar[16], rawpar[17], rawpar[18], rawpar[19], rawpar[20],    \
                                rawpar[21], rawpar[22], rawpar[23], rawpar[24], rawpar[25], rawpar[26], rawpar[27]);   \
      break;                                                                                                           \
    case 29:                                                                                                           \
      ret.t._ret_ = ((_type_##P29) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17],   \
          rawpar[18], rawpar[19], rawpar[20], rawpar[21], rawpar[22], rawpar[23], rawpar[24], rawpar[25], rawpar[26],  \
          rawpar[27], rawpar[28]);                                                                                     \
      break;                                                                                                           \
    case 30:                                                                                                           \
      ret.t._ret_ = ((_type_##P30) * pFunction)(                                                                       \
          rawpar[0], rawpar[1], rawpar[2], rawpar[3], rawpar[4], rawpar[5], rawpar[6], rawpar[7], rawpar[8],           \
          rawpar[9], rawpar[10], rawpar[11], rawpar[12], rawpar[13], rawpar[14], rawpar[15], rawpar[16], rawpar[17],   \
          rawpar[18], rawpar[19], rawpar[20], rawpar[21], rawpar[22], rawpar[23], rawpar[24], rawpar[25], rawpar[26],  \
          rawpar[27], rawpar[28], rawpar[29]);                                                                         \
      break;                                                                                                           \
    }                                                                                                                  \
  } while (false)
          ...
          hb_itemParamStoreForward(static_cast<uint16_t>(iFirst + tmp),
                                   hb_u64ret(pItem, pArg[tmp].iType, pArg[tmp].iEncoding, pArg[tmp].value,
                                             (pArg[tmp].iOptions & HB_DYC_OPT_NULLTERM) != 0
                                                 ? -1
                                                 : static_cast<HB_ISIZ>(hb_parclen(iFirst + tmp))));
