...
static HB_U64 hb_u64par( PHB_ITEM pParam, PHB_DYNARG pArg )
{
   ...
   switch( pArg->iType )
   {
      case HB_DYN_CTYPE_BOOL:
         ...
         r = pArg->bByRef ? static_cast< HB_PTRUINT >( &pArg->value.t.n64 ) : pArg->value.t.n64;
         break;
      ...
      case HB_DYN_CTYPE_STRUCTURE:
      {
         ...
         r = static_cast< HB_PTRUINT >( pArg->hString );
         pArg->value.t.n64 = r;
         break;
      }
      case HB_DYN_CTYPE_CHAR_PTR:
         ...
         switch( pArg->iEncoding )
         {
            case HB_DYN_ENC_ASCII:
            {
               ...
               r = static_cast< HB_PTRUINT >( hb_strunshare( &pArg->hString, s, nLen ) );
               break;
            }
            ...
            case HB_DYN_ENC_UTF16:
            {
               ...
               r = static_cast< HB_PTRUINT >( hb_wstrunshare( &pArg->hString, s, nLen ) );
               break;
            }
            default:
            {
      ...
      case HB_DYN_CTYPE_STRUCTURE_PTR:
         pArg->value.t.n64 = static_cast< HB_PTRUINT >( hb_itemGetPtr( pParam ) );
         r = pArg->bByRef ? static_cast< HB_PTRUINT >( &pArg->value.t.n64 ) : pArg->value.t.n64;
         break;
