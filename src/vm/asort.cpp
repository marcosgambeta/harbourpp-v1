...
static bool hb_itemIsLess(HB_BASEARRAY *pBaseArray, HB_ITEM *pBlock, HB_SIZE nItem1, HB_SIZE nItem2)
{
...
static HB_ISIZ hb_arraySortQuickPartition(HB_BASEARRAY *pBaseArray, HB_ISIZ lb, HB_ISIZ ub, HB_ITEM *pBlock)
{
...
static void hb_arraySortQuick(HB_BASEARRAY *pBaseArray, HB_ISIZ lb, HB_ISIZ ub, HB_ITEM *pBlock)
{
  while (lb < ub) {
...
static void hb_arraySortStart(HB_BASEARRAY *pBaseArray, HB_ITEM *pBlock, HB_SIZE nStart, HB_SIZE nCount)
{
...
static bool hb_arraySortDO(HB_BASEARRAY *pBaseArray, HB_ITEM *pBlock, HB_SIZE *pSrc, HB_SIZE *pBuf, HB_SIZE nCount)
{
  if (nCount > 1) {
