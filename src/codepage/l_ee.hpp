...
constexpr const char *HB_CP_LOWER = "abcdefg\xC4\xA3" "hijklmnopqrs\xC5\xA1" "z\xC5\xBE" "tuvw\xC3\xB5\xC3\xA4\xC3\xB6\xC3\xBC" "xy";
#else
//#define HB_CP_UPPER     "ABCDEFGĢHIJKLMNOPQRSŠZŽTUVWÕÄÖÜXY"
constexpr const char *HB_CP_UPPER = "ABCDEFGĢHIJKLMNOPQRSŠZŽTUVWÕÄÖÜXY";
//#define HB_CP_LOWER     "abcdefgģhijklmnopqrsšzžtuvwõäöüxy"
constexpr const char *HB_CP_LOWER = "abcdefgģhijklmnopqrsšzžtuvwõäöüxy";
#endif
