...
int32_t hb_wctomblen(const wchar_t *szText)
{
...
{
  int32_t length = MultiByteToWideChar(CP_ACP, 0, srcA, -1, nullptr, 0);
...
{
  int32_t length = WideCharToMultiByte(CP_ACP, 0, srcW, -1, nullptr, 0, nullptr, nullptr);
