...
{
  const HB_FILE_FUNC *pDummyFunc = &s_fileFuncs.Accept;
  HB_FILE_FUNC *pFunction = &pFuncs->Accept;

  for (auto iCount = 0; iCount < static_cast<int32_t>(HB_FILE_FUNC_COUNT); iCount++, pDummyFunc++, pFunction++) {
