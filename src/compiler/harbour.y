...
static void hb_compRTVariableAdd( HB_COMP_DECL, HB_EXPR *, HB_BOOL );
static void hb_compRTVariableGen( HB_COMP_DECL, const char * );

static HB_EXPR *hb_compArrayDimPush( HB_EXPR *pInitValue, HB_COMP_DECL );
static void hb_compVariableDim( const char *, HB_EXPR *, HB_COMP_DECL );
...
static void hb_compEnumStart( HB_COMP_DECL, HB_EXPR *pVars, HB_EXPR *pExprs, int32_t descend );
static void hb_compEnumNext( HB_COMP_DECL, HB_EXPR *pExpr, int32_t descend );
static void hb_compEnumEnd( HB_COMP_DECL, HB_EXPR *pExpr );

static void hb_compSwitchStart( HB_COMP_DECL, HB_EXPR * );
static void hb_compSwitchAdd( HB_COMP_DECL, HB_EXPR * );
static void hb_compSwitchEnd( HB_COMP_DECL );

static HB_EXPR *hb_compCheckMethod( HB_COMP_DECL, HB_EXPR *pExpr );
static HB_EXPR *hb_compCheckPassByRef( HB_COMP_DECL, HB_EXPR *pExpr );
...
ErrEndFor    : NEXT      { hb_compErrStru( HB_COMP_PARAM, HB_COMP_ERR_NEXTFOR ); }
             ;

ErrEndCase   : ENDCASE   { hb_compErrStru( HB_COMP_PARAM, HB_COMP_ERR_ENDCASE ); }
             ;

ErrEndIf     : ENDIF     { hb_compErrStru( HB_COMP_PARAM, HB_COMP_ERR_ENDIF ); }
             ;

ErrEndWith   : ENDWITH   { hb_compErrStru( HB_COMP_PARAM, HB_COMP_ERR_ENDWITH ); }
             ;

ErrEndSeq    : ENDSEQ    { hb_compErrStru( HB_COMP_PARAM, HB_COMP_ERR_ENDSEQ ); }
             ;

ErrEndWhile  : ENDDO     { hb_compErrStru( HB_COMP_PARAM, HB_COMP_ERR_ENDDO ); }
             ;

ErrEndSwitch : ENDSWITCH { hb_compErrStru( HB_COMP_PARAM, HB_COMP_ERR_ENDSWITCH ); }
             ;
...
static void hb_compLoopLoop( HB_COMP_DECL )
{
   ...
   else
   {
      ...
      {
         uint16_t wWithObjectCnt = pLast->wWithObjectCnt;
...
static void hb_compRTVariableAdd( HB_COMP_DECL, HB_EXPR *pVar, HB_BOOL bPopInitValue )
{
...
static HB_EXPR *hb_compArrayDimPush( HB_EXPR *pInitValue, HB_COMP_DECL )
{
   uint16_t uCount = ( uint16_t ) hb_compExprListLen( pInitValue );
...
static void hb_compVariableDim( const char * szName, HB_EXPR *pInitValue, HB_COMP_DECL )
{
   ...
   {
      HB_EXPR *pVar = hb_compExprNewVar( szName, HB_COMP_PARAM );
      HB_EXPR *pAssign;
...
{
   const char * szName = hb_compExprAsSymbol( ( HB_EXPR * ) cargo );

   if( szName )
      hb_compForStart( HB_COMP_PARAM, szName, HB_COMP_PARAM->fDescend ? -1 : 1 );

   hb_compExprGenPush( ( HB_EXPR * ) dummy, HB_COMP_PARAM );  /* expression */
   hb_compExprGenPush( ( HB_EXPR * ) cargo, HB_COMP_PARAM );  /* variable */
}
...
static void hb_compSwitchStart( HB_COMP_DECL, HB_EXPR * pExpr )
{
...
static void hb_compSwitchAdd( HB_COMP_DECL, HB_EXPR * pExpr )
{
