...
void hb_compPCodeEval(HB_HFUNC *pFunc, const PHB_PCODE_FUNC *pFunctions, void *cargo)
{
  HB_SIZE nPos = 0;
  HB_SIZE nSkip;
...
void hb_compPCodeTrace(HB_HFUNC *pFunc, const PHB_PCODE_FUNC *pFunctions, void *cargo)
{
  HB_SIZE nPos = 0;
