...
#if 0
         HB_TRACE( HB_TR_DEBUG, ( "Error in adsxSysName: %lu  pArea->adsarea.hTable %p", static_cast<HB_ULONG>(u32RetVal), static_cast<void*>(static_cast<uintptr_t>(pArea->adsarea.hTable)) ) );
#endif
