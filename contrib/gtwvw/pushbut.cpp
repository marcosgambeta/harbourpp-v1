...
/*   RECT r; */
   ...
   if( hWndCB )
   {
      ...
      SendMessage(
         static_cast< HWND >( hWndCB ),
         CB_SETDROPPEDWIDTH,
         static_cast< WPARAM >( NewLongComboWidth ) + 100, /* LongComboWidth+100 */
         static_cast< LPARAM >( 0 )
         );
...
HB_FUNC( WVW_CBISDROPPED )
{
   ...
   bDropped = SendMessage( static_cast< HWND >( pcd->hWndCtrl ),
                           CB_GETDROPPEDSTATE,
                           static_cast< WPARAM >( 0 ),
                           static_cast< LPARAM >( 0 )
                           );
