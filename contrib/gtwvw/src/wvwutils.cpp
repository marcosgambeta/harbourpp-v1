...
HB_FUNC( WIN_SENDMESSAGE )
{
   ...
   hb_retnl(static_cast<ULONG>(SendMessage(reinterpret_cast<HWND>(HB_PARHANDLE(1)),static_cast<UINT>(hb_parni(2)),
...
HB_FUNC( WIN_SENDDLGITEMMESSAGE )
{
   ...
   hb_retnl(static_cast<LONG>(SendDlgItemMessage(reinterpret_cast<HWND>(HB_PARHANDLE(1)),
            static_cast<int>(hb_parni(2)), static_cast<UINT>(hb_parni(3)),
...
{
   USHORT iLen  = static_cast<USHORT>(SendMessage(static_cast<HWND>(GetDlgItem(reinterpret_cast<HWND>(HB_PARHANDLE(1)), hb_parni(2))), static_cast<UINT>(WM_GETTEXTLENGTH), 0, 0)) + 1;
...
HB_FUNC( WVW_XBVISIBLE )
{
   ...
   byte bStyle;
   auto hWndXB = static_cast<HWND>(uiXBid == 0 ? nullptr : FindControlHandle(usWinNum, WVW_CONTROL_SCROLLBAR, uiXBid, &bStyle));
