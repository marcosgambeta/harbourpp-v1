 ...
 *
 * Copyright 2008-2014 Viktor Szakats
 *
...
HB_FUNC( WAPI_ISUSERANADMIN )
{
   ...
   if( hLib )
   {
      ...
      ISUSERANADMIN pIsUserAnAdmin = reinterpret_cast<ISUSERANADMIN>(reinterpret_cast<void*>(HB_WINAPI_GETPROCADDRESS(hLib, "IsUserAnAdmin")));
      if( pIsUserAnAdmin )
      {
