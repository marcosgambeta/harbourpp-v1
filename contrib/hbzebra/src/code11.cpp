...
static void _code11_add(HB_BITBUFFER *pBits, char code, int32_t iFlags, bool fLast)
{
  int32_t i;
...
HB_ZEBRA *hb_zebra_create_code11(const char *szCode, HB_SIZE nLen, int32_t iFlags)
{
  uint32_t csum, ksum, i;
  auto iLen = static_cast<uint32_t>(nLen);
