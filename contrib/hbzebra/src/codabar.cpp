...
static void _codabar_add(HB_BITBUFFER *pBits, char code, int32_t iFlags, bool fLast)
{
  int32_t i;
...
HB_ZEBRA *hb_zebra_create_codabar(const char *szCode, HB_SIZE nLen, int32_t iFlags)
{
  uint32_t i;
