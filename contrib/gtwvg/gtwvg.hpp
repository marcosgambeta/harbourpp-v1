...
extern HB_EXPORT HB_BOOL       hb_wvt_gtRenderPicture(int32_t x1, int32_t y1, int32_t wd, int32_t ht, IPicture * iPicture, HB_BOOL bDoNotScale);
extern HB_EXPORT HB_BOOL       hb_wvt_gtDestroyPicture(IPicture *iPicture);
extern HB_EXPORT HB_BOOL       hb_wvt_DrawImage(HDC hdc, int32_t x1, int32_t y1, int32_t wd, int32_t ht, LPCTSTR image, HB_BOOL bDoNotScale);
...
extern HB_EXPORT int32_t           nCopyAnsiToWideChar(LPWORD lpWCStr, LPCSTR lpAnsiIn);
