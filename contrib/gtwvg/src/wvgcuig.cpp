...
HB_FUNC(WVG_LABEL)
{
  ...
  HB_STRNCPY(lf.lfFaceName, (!HB_ISCHAR(9) ? pWVT->fontFace : HB_PARSTR(9, &hText, nullptr)),
...
HB_FUNC(WVG_LABELEX2)
{
  ...
  HB_STRNCPY(lf.lfFaceName, (!HB_ISCHAR(11) ? pWVT->fontFace : HB_PARSTR(11, &hText, nullptr)),
             HB_SIZEOFARRAY(lf.lfFaceName) - 1);
  hb_strfree(hText);
