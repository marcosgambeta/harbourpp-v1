...
METHOD GDBarCode:New( nTypeCode )
...
METHOD GDBarCode:FindCharCode( cString, cChar )
...
METHOD GDBarCode:Draw128( cText, cModeCode )
...
METHOD GDBarCode:DrawI25( cText )
...
METHOD GDBarCode:MixCode( value )
