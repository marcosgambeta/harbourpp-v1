...
{
   hbwapi_ret_L(ImageList_DrawEx(hbwapi_par_raw_HIMAGELIST(1), hbwapi_par_INT(2), hbwapi_par_raw_HDC(3), hbwapi_par_INT(4), hbwapi_par_INT(5),
                                 hbwapi_par_INT(6), hbwapi_par_INT(7), hbwapi_par_COLORREF(8), hbwapi_par_COLORREF(9), hbwapi_par_UINT(10)));
}
