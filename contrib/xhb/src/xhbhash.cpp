...
HB_FUNC_EXTERN( HB_HCASEMATCH ); HB_FUNC( HSETCASEMATCH ) {HB_FUNC_EXEC( HB_HCASEMATCH ); hb_itemReturn(hb_param(1, Harbour::Item::HASH));}
HB_FUNC_EXTERN( HB_HAUTOADD   ); HB_FUNC( HSETAUTOADD )   {HB_FUNC_EXEC( HB_HAUTOADD ); hb_itemReturn(hb_param(1, Harbour::Item::HASH));}
