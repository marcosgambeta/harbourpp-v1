...
static HB_UINT SizeOfCStructure(PHB_ITEM aDef, HB_UINT uiAlign)
{
  ...
  for (nIndex = 0; nIndex < nLen; nIndex++) {
    ...
    if (uiSize) {
      ...
      if ((cShift = static_cast<uint8_t>(uiSize % uiPad)) > 0) {
        uiSize += uiPad - cShift;
      }
    }
  ...
  if ((cShift = static_cast<uint8_t>(uiSize % uiAlign)) > 0) {
...
static uint8_t *ArrayToStructure(PHB_ITEM aVar, PHB_ITEM aDef, HB_UINT uiAlign, HB_UINT *puiSize)
{
  ...
  *puiSize = SizeOfCStructure(aDef, uiAlign);
  ...
  auto Buffer = static_cast<uint8_t *>(hb_xgrab(*puiSize + 1));
  ...
  for (nIndex = 0; nIndex < nLen; nIndex++) {
    ...
    case CTYPE_CHAR_PTR:          /* char * */
    case CTYPE_UNSIGNED_CHAR_PTR: /* unsigned char * */
      if ((pBaseVar->pItems + nIndex)->type && (pBaseVar->pItems + nIndex)->type != Harbour::Item::STRING &&
    ...
    case CTYPE_SHORT_PTR:          /* short * */
    case CTYPE_UNSIGNED_SHORT_PTR: /* unsigned short * */
      if ((pBaseVar->pItems + nIndex)->type && (pBaseVar->pItems + nIndex)->type != Harbour::Item::POINTER &&
          (pBaseVar->pItems + nIndex)->type != Harbour::Item::LONG) {
        hb_errRT_BASE(EG_ARG, 2023, nullptr, "ArrayToStructure", 3, hb_paramError(1), hb_paramError(2),
                      hb_paramError(3));
        return nullptr;
    ...
    case CTYPE_CHAR: /* char */
      if ((pBaseVar->pItems + nIndex)->type) {
        *(reinterpret_cast<char *>(Buffer + uiOffset)) =
            static_cast<char>((pBaseVar->pItems + nIndex)->item.asInteger.value);
      } else {
    ...
    case CTYPE_UNSIGNED_CHAR: /* unsigned char */
      if ((pBaseVar->pItems + nIndex)->type) {
        *(static_cast<uint8_t *>(Buffer + uiOffset)) =
            static_cast<uint8_t>((pBaseVar->pItems + nIndex)->item.asInteger.value);
      } else {
        *(static_cast<uint8_t *>(Buffer + uiOffset)) = 0;
      }
      break;
    ...
    case CTYPE_CHAR_PTR: /* char * */
      ...
      case Harbour::Item::INTEGER:
        *((char **)(Buffer + uiOffset)) =
            reinterpret_cast<char *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value));
        break;
#endif
      case Harbour::Item::LONG:
        *((char **)(Buffer + uiOffset)) =
            reinterpret_cast<char *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value));
        break;
    ...
    case CTYPE_UNSIGNED_CHAR_PTR: /* unsigned char * */
      switch ((pBaseVar->pItems + nIndex)->type) {
      case Harbour::Item::STRING:
        *((uint8_t **)(Buffer + uiOffset)) =
            reinterpret_cast<uint8_t *>((pBaseVar->pItems + nIndex)->item.asString.value);
        break;

      case Harbour::Item::POINTER:
        *((uint8_t **)(Buffer + uiOffset)) = static_cast<uint8_t *>((pBaseVar->pItems + nIndex)->item.asPointer.value);
        break;

#if UINT_MAX == ULONG_MAX
      case Harbour::Item::INTEGER:
        *((uint8_t **)(Buffer + uiOffset)) =
            reinterpret_cast<uint8_t *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value));
        break;
#endif
      case Harbour::Item::LONG:
        *((uint8_t **)(Buffer + uiOffset)) =
            reinterpret_cast<uint8_t *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value));
        break;

      default:
        *((uint8_t **)(Buffer + uiOffset)) = nullptr;
        break;
      }
      break;
    ...
    case CTYPE_UNSIGNED_SHORT: /* unsigned short */
      if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::INTEGER) {
        *((unsigned short *)(Buffer + uiOffset)) =
            static_cast<unsigned short>((pBaseVar->pItems + nIndex)->item.asInteger.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::LONG) {
        *((unsigned short *)(Buffer + uiOffset)) =
            static_cast<unsigned short>((pBaseVar->pItems + nIndex)->item.asLong.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::DOUBLE) {
        *((unsigned short *)(Buffer + uiOffset)) =
            static_cast<unsigned short>((pBaseVar->pItems + nIndex)->item.asDouble.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::NIL) {
    ...
    case CTYPE_SHORT_PTR: /* short * */
      ...
      case Harbour::Item::INTEGER:
        *((short **)(Buffer + uiOffset)) =
            (short *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value);
        break;
#endif
      case Harbour::Item::LONG:
        *((short **)(Buffer + uiOffset)) =
            (short *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value);
        break;
    ...
    case CTYPE_UNSIGNED_SHORT_PTR: /* unsigned short * */
      ...
      case Harbour::Item::POINTER:
        *((unsigned short **)(Buffer + uiOffset)) =
            (unsigned short *)((pBaseVar->pItems + nIndex)->item.asPointer.value);
        break;

#if UINT_MAX == ULONG_MAX
      case Harbour::Item::INTEGER:
        *((unsigned short **)(Buffer + uiOffset)) =
            (unsigned short *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value);
        break;
#endif
      case Harbour::Item::LONG:
        *((unsigned short **)(Buffer + uiOffset)) =
            (unsigned short *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value);
        break;
    ...
    case CTYPE_UNSIGNED_INT: /* unsigned int */
      if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::INTEGER) {
        *((unsigned int *)(Buffer + uiOffset)) =
            static_cast<unsigned int>((pBaseVar->pItems + nIndex)->item.asInteger.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::LONG) {
        *((unsigned int *)(Buffer + uiOffset)) =
            static_cast<unsigned int>((pBaseVar->pItems + nIndex)->item.asLong.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::DOUBLE) {
        *((unsigned int *)(Buffer + uiOffset)) =
            static_cast<unsigned int>((pBaseVar->pItems + nIndex)->item.asDouble.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::NIL) {
    ...
    case CTYPE_INT_PTR: /* int * */
      ...
      case Harbour::Item::INTEGER:
        *((int **)(Buffer + uiOffset)) =
            (int *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value);
        break;
#endif
      case Harbour::Item::LONG:
    ...
    case CTYPE_UNSIGNED_INT_PTR: /* unsigned int * */
      ...
      case Harbour::Item::INTEGER:
        *((unsigned int **)(Buffer + uiOffset)) =
            (unsigned int *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value);
        break;
#endif
      case Harbour::Item::LONG:
        *((unsigned int **)(Buffer + uiOffset)) =
            (unsigned int *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value);
        break;
    ...
    case CTYPE_UNSIGNED_LONG: /* unsigned long */
      if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::INTEGER) {
        *((unsigned long *)(Buffer + uiOffset)) =
            static_cast<unsigned long>((pBaseVar->pItems + nIndex)->item.asInteger.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::LONG) {
        *((unsigned long *)(Buffer + uiOffset)) =
            static_cast<unsigned long>((pBaseVar->pItems + nIndex)->item.asLong.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::DOUBLE) {
        *((unsigned long *)(Buffer + uiOffset)) =
            static_cast<unsigned long>((pBaseVar->pItems + nIndex)->item.asDouble.value);
      } else if ((pBaseVar->pItems + nIndex)->type == Harbour::Item::NIL) {
    ...
    case CTYPE_LONG_PTR: /* long * */
      ...
      case Harbour::Item::INTEGER:
        *((long **)(Buffer + uiOffset)) =
            (long *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value);
        break;
#endif
      case Harbour::Item::LONG:
        *((long **)(Buffer + uiOffset)) =
            (long *)static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value);
        break;
    ...
    case CTYPE_UNSIGNED_LONG_PTR: /* unsigned long * */
      ...
      case Harbour::Item::POINTER:
        *((unsigned long **)(Buffer + uiOffset)) =
            static_cast<unsigned long *>((pBaseVar->pItems + nIndex)->item.asPointer.value);
        break;

#if UINT_MAX == ULONG_MAX
      case Harbour::Item::INTEGER:
        *((unsigned long **)(Buffer + uiOffset)) = reinterpret_cast<unsigned long *>(
            static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value));
        break;
#endif
      case Harbour::Item::LONG:
        *((unsigned long **)(Buffer + uiOffset)) =
            reinterpret_cast<unsigned long *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value));
        break;
    ...
    case CTYPE_FLOAT_PTR: /* float * */
      switch ((pBaseVar->pItems + nIndex)->type) {
      case Harbour::Item::POINTER:
        *((float **)(Buffer + uiOffset)) = static_cast<float *>((pBaseVar->pItems + nIndex)->item.asPointer.value);
        break;

#if UINT_MAX == ULONG_MAX
      case Harbour::Item::INTEGER:
        *((float **)(Buffer + uiOffset)) =
            reinterpret_cast<float *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value));
        break;
#endif
      case Harbour::Item::LONG:
        *((float **)(Buffer + uiOffset)) =
            reinterpret_cast<float *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value));
        break;
    ...
    case CTYPE_DOUBLE_PTR: /* double * */
      switch ((pBaseVar->pItems + nIndex)->type) {
      case Harbour::Item::POINTER:
        *((double **)(Buffer + uiOffset)) = static_cast<double *>((pBaseVar->pItems + nIndex)->item.asPointer.value);
        break;

#if UINT_MAX == ULONG_MAX
      case Harbour::Item::INTEGER:
        *((double **)(Buffer + uiOffset)) =
            reinterpret_cast<double *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value));
        break;
#endif
      case Harbour::Item::LONG:
        *((double **)(Buffer + uiOffset)) =
            reinterpret_cast<double *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value));
        break;
    ...
    case CTYPE_VOID_PTR: /* void * */
      switch ((pBaseVar->pItems + nIndex)->type) {
      case Harbour::Item::POINTER:
        *(reinterpret_cast<void **>(Buffer + uiOffset)) =
            static_cast<void *>((pBaseVar->pItems + nIndex)->item.asPointer.value);
        break;

#if UINT_MAX == ULONG_MAX
      case Harbour::Item::INTEGER:
        *(reinterpret_cast<void **>(Buffer + uiOffset)) =
            reinterpret_cast<void *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asInteger.value));
        break;
#endif
      case Harbour::Item::LONG:
        *(reinterpret_cast<void **>(Buffer + uiOffset)) =
            reinterpret_cast<void *>(static_cast<HB_PTRUINT>((pBaseVar->pItems + nIndex)->item.asLong.value));
        break;
    ...
    default:
      if ((pBaseDef->pItems + nIndex)->item.asInteger.value > CTYPE_STRUCTURE) {
        ...
        if (pStructure->isLong()) {
          if ((pBaseDef->pItems + nIndex)->item.asInteger.value > CTYPE_STRUCTURE_PTR) {
            *(reinterpret_cast<void **>(Buffer + uiOffset)) =
                reinterpret_cast<void *>(static_cast<HB_PTRUINT>(pStructure->item.asLong.value));
          } else {
            memcpy(static_cast<void *>(Buffer + uiOffset),
                   reinterpret_cast<void *>(static_cast<HB_PTRUINT>(pStructure->item.asLong.value)), uiMemberSize);
          }
        }
#if UINT_MAX == ULONG_MAX
          ...
          if ((pBaseDef->pItems + nIndex)->item.asInteger.value > CTYPE_STRUCTURE_PTR) {
            *(reinterpret_cast<void **>(Buffer + uiOffset)) =
                reinterpret_cast<void *>(static_cast<HB_PTRUINT>(pStructure->item.asInteger.value));
          } else {
            memcpy(static_cast<void *>(Buffer + uiOffset),
                   reinterpret_cast<void *>(static_cast<HB_PTRUINT>(pStructure->item.asInteger.value)), uiMemberSize);
          }
        }
#endif
          ...
          if ((pBaseDef->pItems + nIndex)->item.asInteger.value > CTYPE_STRUCTURE_PTR) {
            *(reinterpret_cast<void **>(Buffer + uiOffset)) = static_cast<void *>(pInternalBuffer->item.asString.value);
            ...
            memcpy(static_cast<void *>(Buffer + uiOffset), static_cast<void *>(pInternalBuffer->item.asString.value),
                   uiMemberSize);
          }
        } else {
          hb_errRT_BASE(EG_ARG, 2023, nullptr, "ArrayToStructure", 3, hb_paramError(1), hb_paramError(2),
  ...
  for (nIndex = 0; nIndex < nLen; nIndex++) {
    ...
    default:
      if ((pBaseDef->pItems + nIndex)->item.asInteger.value > CTYPE_STRUCTURE_PTR) {
        ...
        hb_errRT_BASE(EG_ARG, 2023, nullptr, "StructureToArray", 3, hb_paramError(1), hb_paramError(2),
                      hb_paramError(3));
        return pRet;
      }
    }
...
#if 0
               TraceLog(nullptr, "IDENTICAL: %s\n", *(static_cast<char**>(Buffer + uiOffset)));
#endif
...
#endif
        hb_itemPutC(pBaseVar->pItems + nIndex, *(reinterpret_cast<char **>(Buffer + uiOffset)));
      }
      break;
    ...
    case CTYPE_LONG: /* long */
      hb_itemPutNL(pBaseVar->pItems + nIndex, *(reinterpret_cast<long *>(Buffer + uiOffset)));
      break;

    case CTYPE_UNSIGNED_LONG: /* unsigned long */
      hb_itemPutNL(pBaseVar->pItems + nIndex,
                   static_cast<long>(*(reinterpret_cast<unsigned long *>(Buffer + uiOffset))));
      break;
    ...
    case CTYPE_FLOAT: /* float */
      hb_itemPutND(pBaseVar->pItems + nIndex, static_cast<double>(*(reinterpret_cast<float *>(Buffer + uiOffset))));
      break;
    ...
    case CTYPE_DOUBLE: /* double */
      hb_itemPutND(pBaseVar->pItems + nIndex, *(reinterpret_cast<double *>(Buffer + uiOffset)));
      break;
    ...
    default: {
      ...
      if ((pBaseDef->pItems + nIndex)->item.asInteger.value > CTYPE_STRUCTURE_PTR) {
        ...
        hb_itemPutCRawStatic(pInternalBuffer, reinterpret_cast<char *>(static_cast<uint8_t *>(Buffer + uiOffset)),
                             uiNestedSize);
