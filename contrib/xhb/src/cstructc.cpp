...
#if UINT_MAX == ULONG_MAX
               case HB_IT_INTEGER:
                  *( ( HB_BYTE ** ) ( Buffer + uiOffset ) ) = ( HB_BYTE * ) static_cast< HB_PTRUINT >( ( pBaseVar->pItems + nIndex )->item.asInteger.value );
                  break;
#endif
               case HB_IT_LONG:
                  *( ( HB_BYTE ** ) ( Buffer + uiOffset ) ) = ( HB_BYTE * ) static_cast< HB_PTRUINT >( ( pBaseVar->pItems + nIndex )->item.asLong.value );
                  break;
