...
#if !defined(HB_OPENSSL_NO_APPLINK) && defined(HB_OS_WIN) && defined(HB_CPU_X86) && !defined(HB_OPENSSL_STATIC) &&     \
...
HB_FUNC(OPENSSL_VERSION)
{
  ...
  case HB_OPENSSL_VERSION:
    ...
    break;
  case HB_OPENSSL_CFLAGS:
    value = OPENSSL_CFLAGS;
    break;
  case HB_OPENSSL_BUILT_ON:
    value = OPENSSL_BUILT_ON;
    break;
  case HB_OPENSSL_PLATFORM:
    value = OPENSSL_PLATFORM;
    break;
  case HB_OPENSSL_DIR:
    value = OPENSSL_DIR;
    break;
  ...
  case HB_SSLEAY_VERSION:
    ...
    break;
  case HB_SSLEAY_CFLAGS:
    value = SSLEAY_CFLAGS;
    break;
  case HB_SSLEAY_BUILT_ON:
    value = SSLEAY_BUILT_ON;
    break;
  case HB_SSLEAY_PLATFORM:
    value = SSLEAY_PLATFORM;
    break;
  case HB_SSLEAY_DIR:
    value = SSLEAY_DIR;
    break;
